...
public class PostController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "존재하지 않는 게시글에 좋아요 추가 에러"),
    ...
    public ResponseEntity<ApiUtils.ApiResult<Boolean>> addLike(
        ...
        // 좋아요 추가 로직 실행
        boolean isLiked = postService.addLike(id, userDetails.user());
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "존재하지 않는 게시글에 좋아요 삭제 에러"),
    ...
    public ResponseEntity<ApiUtils.ApiResult<Boolean>> removeLike(
        ...
        // 좋아요 삭제 로직 실행
        boolean isRemoved = postService.removeLike(id, userDetails.user());

        // 좋아요 삭제 결과 반환
        return ResponseEntity.ok(ApiUtils.success(isRemoved));
    }
